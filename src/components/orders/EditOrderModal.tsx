...
import type { Order, WeightVariant, GrindType, PaymentMethod } from '@/types'
      ...
      <div
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold text-foreground text-sm">Edit Order</h2>
            ...
            {activeSection === 'shipping' && (
              <div className="space-y-4">
                ...
                <div className="flex justify-between gap-3 pt-1">
                  ...
                  <button type="submit"
                    disabled={updateOrder.isPending || !name || !email || !phone || !shippingAddress || items.some(it => !it.product)}
                    ...
                    {updateOrder.isPending
                      ...
                      : <><Package className="w-4 h-4" />Save Changes</>}
                  </button>
                </div>
              </div>
            )}
